...
public class EmptyLayout extends FrameLayout implements View.OnClickListener {
    ...
    private SpinKitView mEmptyLoading;
    ...
    /**
     * 在AndroidStudio的library的module中无法使用ButterKnife
     */
    private void initView() {
        ...
        mEmptyLoading = (SpinKitView) findViewById(R.id.empty_loading);
