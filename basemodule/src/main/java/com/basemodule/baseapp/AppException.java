package com.basemodule.baseapp;
...
public class AppException extends Exception implements UncaughtExceptionHandler {
    ...
    private static String exceptionLogAdd = Environment.getExternalStorageDirectory().getAbsolutePath() + "/BaseModule/Log/"; // 异常日志保存的文件夹
     ...
     * @return
     */
    public static AppException getAppExceptionHandler(String exceptionLogAdd) {
        AppException.exceptionLogAdd = exceptionLogAdd;
